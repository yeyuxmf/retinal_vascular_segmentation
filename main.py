...
def train(args, io):
    ...
    file_path = "G:/vasular/DRIVE/training/images/"
    label_path = "G:/vasular/DRIVE/training/1st_manual/"
    ...
    focalLoss = WeightedFocalLoss()#FocalLoss2d(gamma=2)
    ...
    for epoch in range(0, args.epochs):
        ...
        for train_data, train_label, weight_ in train_loader:
            ...
            with autocast():
                ...
                sec_loss = focalLoss(outputs_seg[:, 0, :, :], train_label[:, :, :])

                outputs_soft = F.sigmoid(outputs_seg[:, 0, :, :])#torch.softmax(outputs_seg, dim=1)[:, 1, :, :]
